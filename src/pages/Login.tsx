        ...
        <div className="flex-col w-[100%] sm:basis-2/4 md:basis-1/4 bg-gray-100">
          <div className="justify-center items-center">
            <div className="flex flex-col justify-center items-center py-6">
              ...
              <strong className="mt-8 text-2xl md:text-4xl text-orange-500 text-center">Login</strong>
            </div>
            <Form onSubmit={() => {}}>
            ...
            <div className="flex justify-around items-center">
              <div>
                <button className="text-center text-base font-extrabold bg-orange-500 p-2 rounded-lg mx-auto mr-1" onClick={handleGloogleSingIn}>
                  <GoogleLogo size={30} />
                </button>
              </div>
            </div>
            <div className="flex justify-around items-center">
              ...
              <div className='flex justify-center items-center'>
                ...
                <Link className="ml-2 text-base font-bold text-orange-500 text-center" to="/SignUp" >Criar conta </Link>
              </div>
            </div>
          </div>
        </div>
